...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { name: @district.name, valid_votes: @district.valid_votes, voivodship_id: @district.voivodship_id }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { name: @district.name, valid_votes: @district.valid_votes, voivodship_id: @district.voivodship_id }
    assert_redirected_to district_path(assigns(:district))
  end
